	...
	public static void main(String[] args) {
		...
		Session session = Session.getDefaultInstance(props,
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				...
				return new PasswordAuthentication("SENDER EMAIL ADDRESS", "Your Password");
			}
		...
		try {
			...
			String filename = System.getProperty("user.dir")+"\\Extent Reports\\extentreport.html";
			String file = "AutomationReport.html";
